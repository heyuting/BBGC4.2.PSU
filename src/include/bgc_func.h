...
int decomp(double soilTobs, const epconst_struct* epc, epvar_struct* epv, 
const siteconst_struct* sitec, cstate_struct* cs, cflux_struct* cf,
nstate_struct* ns, nflux_struct* nf, ntemp_struct* nt);

//if we want to modify allocation function, to add an input parameter like soil moisture
...
ntemp_struct* nt, wstate_struct* ws, phenology_struct* phen, double naddfrac, int mode); //add wstate_struct* ws 06/24/2014; add phenology_struct* phen 01/29/2014
