...
%load sc.dayout.ascii
 ...
 fdayout74=fopen([Dir 'outputs/sc.dayout74.ascii']);
 dayout74=textscan(fdayout74,repmat('%f',[1,42]));
 fclose(fdayout74);
 dailyGPP74=dayout74{22};
 
 fdayout61=fopen([Dir 'outputs/sc.dayout61.ascii']);
 ...
 fannout61=fopen([Dir 'outputs/sc.annout61.ascii']);
 ...
 fannout74=fopen([Dir 'outputs/sc.annout74.ascii']);
...
%set(fig, 'ScreenPixelsPerInch', 120)
print(fig,'-dpng' ,[FigDir Outname]);
%  '-dpng'
